    ...
    return (
        <div className={classes.navWrapper}>
            ...
            <div className={visible ? classes.navigationAppear : classes.navigationHide}>
                <NavLink onClick={changeMode} className={classes.link} to="/pre-junior">pre-junior level
                    homeworks</NavLink>
                <NavLink onClick={changeMode} className={classes.link} to="/junior">junior level homeworks</NavLink>
                <NavLink onClick={changeMode} className={classes.link} to="/junior-plus">junior-plus level
                    homeworks</NavLink>
            </div>
        </div>
    )
